...
let AuthController = class AuthController {
    ...
    async loginWithPin(loginDto) {
        return this.authService.loginWithPin(loginDto.companyId, loginDto.name?.trim() ?? '', loginDto.pin);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login with name and PIN (for staff)' }),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "createStaffMember", null);
__decorate([

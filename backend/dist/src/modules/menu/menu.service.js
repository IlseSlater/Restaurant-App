...
let MenuService = class MenuService {
    ...
    async updateMenuItem(id, updateDto) {
        const _a = updateDto !== null && updateDto !== void 0 ? updateDto : {}, { id: _ignoreId, companyId: _ignoreCompanyId, available, prepTimeMin, prepTime, preparationTime } = _a, rest = __rest(_a, ["id", "companyId", "available", "prepTimeMin", "prepTime", "preparationTime"]);
        const data = Object.assign({}, rest);
        if (typeof available === 'boolean') {
            data.isAvailable = available;
        }
        const prepMins = (prepTimeMin !== null && prepTimeMin !== void 0 ? prepTimeMin : prepTime) !== null && prepTimeMin !== void 0 ? prepTimeMin : preparationTime;

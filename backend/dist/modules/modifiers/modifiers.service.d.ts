...
export declare class ModifiersService {
    ...
    linkModifierGroupToMenuItem(menuItemId: string, dto: LinkModifierGroupDto): Promise<{
        modifierGroup: {
            options: {
                id: string;
                name: string;
    ...
    unlinkModifierGroupFromMenuItem(menuItemId: string, modifierGroupId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        menuItemId: string;
